...
export var MCPRINTA = `
    <div class="printform" id="mcprint01">
        ...
        <table>
            ...
            <tr>
                <td class="textcell"> Rodné příjmení/surname at birth </td>
                <td id="PBsname02" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Jméno/first and middle names </td>
                <td id="PFname02" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Datum narození/date of birth </td>
                <td id="PDob02" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Místo narození/place of birth </td>
                <td id="PPob02" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Stát narození/country of birth </td>
                <td id="PCob02" class="datacell"> </td>
            </tr>
        </table>
        ...
        <table>
            ...
            <tr>
                <td class="textcell"> Místo uzavření manželství/place of marriage </td>
                <td id="PPom01" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Stát uzavření manželství/country of marriage </td>
                <td id="PCom01" class="datacell"> </td>
            <tr>
                <td class="textcell"> Náboženství v době uzavření manželství u osob, které se uzavřeli manželství do 31. 12. 1949/ religion at time of marriage prior to 31.12.1949 </td>
                <td id="PReli" class="datacell"> </td>
            </tr>
        </table>
    </div>
...
export var DCPRINTA = `
    <div class="printform" id="dcprint01">
        ...
        <table>
            ...
            <tr>
                <td class="textcell"> Datum úmrtí /date of death </td>
                <td id="PDod01" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Místo úmrtí/place of death </td>
                <td id="PPod01" class="datacell"> </td>
            </tr>
            <tr>
                <td class="textcell"> Stát úmrtí/country of death </td>
                <td id="PCod01" class="datacell"> </td>
            <tr>
                <td class="textcell"> Náboženství v době úmrtí u osob, které zemřeli do 31. 12. 1949/ religion at time of death prior to 31.12.1949 </td>
                <td id="PReli" class="datacell"> </td>
            </tr>
        </table>
    </div>
